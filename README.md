...
- **⚡️ Zero-Dependency Architecture:** Full Spaced Repetition logic implemented in pure vanilla JavaScript. No bloated dependencies, easily bypassing Amplenote's internal 260KB plugin `eval()` limit.
...
- **🎨 Premium UI & Fallback:** 
  ...
  - *Free Tier Users:* Run review sessions gracefully via native Amplenote Prompt/Alert dialogs.
...
4. **Important Installation Quirk:** Open Amplenote in an **incognito Chrome window** (to bypass desktop sandbox installation bugs). Navigate to **Settings -> Plugins**, locate your note, and click **Add Plugin**.
