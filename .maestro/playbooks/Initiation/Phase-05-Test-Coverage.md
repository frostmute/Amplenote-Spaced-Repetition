...
- [ ] Write unit tests for all pure utility functions:
...
- [ ] Implement mock tests for Amplenote API interactions:
...
- [ ] Audit and document final test coverage:
  - Run the coverage report and ensure line and branch coverage exceeds 90%.
